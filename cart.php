            ...
            <div class="row">
                <form action="" method="post">
                    <table class="table table-bordered text-center">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><img src="./images/<?php echo $product_image; ?>" alt="#" class="cart-img"></td>
                    ...
                    <div class="d-flex mb-5">
                        ...
                        <button class='bg-secondary p-2 border-0' style='margin-right : 5px; '><a href='./users/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>
