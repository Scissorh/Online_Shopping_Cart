            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="./users/user_register.php">My account</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="profile.php">Contact</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row my-4">
            <div class="col-md-2 col-lg-2">
                <ul class="navbar-nav bg-secondary text-center" style="height: 100vh;">
                    ...
                    echo
                    "<li class='nav-item'>
                        <img src='./users/user_images/$user_image' alt='imag class='profile_img' style=' width: 83%;
                        margin: auto;
                        display: block;
                        height: 90%;'>
                    </li>";
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="./users/logout.php">
                            Logout
                        </a>
                    </li>
                </ul>
